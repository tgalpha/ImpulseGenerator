...
class ImpulseGeneratorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    ImpulseGeneratorPlugin();
    ~ImpulseGeneratorPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(ImpulseGenerator);	// Exposes our PluginContainer structure that contains the info for our plugin
