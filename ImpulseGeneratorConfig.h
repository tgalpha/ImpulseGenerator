...
#ifndef ImpulseGeneratorConfig_H
#define ImpulseGeneratorConfig_H
...
namespace ImpulseGeneratorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 31232;
}

#endif // ImpulseGeneratorConfig_H
