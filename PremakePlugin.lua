...
local Plugin = {}
Plugin.name = "ImpulseGenerator"
Plugin.factoryheader = "../SoundEnginePlugin/ImpulseGeneratorSourceFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "ImpulseGeneratorSourceShared.cpp"
}
...
{
    "ImpulseGeneratorSourceShared.cpp",
    "ImpulseGeneratorSourceFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "ImpulseGenerator.def",
    "ImpulseGenerator.xml",
    "*.rc",
}
